...
public class Util
{
    ...
    @Nullable
    public static URI getIPAPIUrlForIP()
    {
        if (Constants.USER_IP != null)
        {
            // https://ip-api.com/docs/api:json View what "fields" keyword does here. "status" "message" "city" "district" "lat" "lon"
            return URI.create("http://ip-api.com/json/%s?fields=573648".formatted(Constants.USER_IP));
        }
        return null;
    }
}
