...
### Actual technical disclaimers and notes.. if you want.

Currently, I use these endpoints / APIs to determine your weather.

- https://checkip.amazonaws.com (To fetch IP)
- https://postcodes.io (To fetch Lat/Long via your Postcode)
